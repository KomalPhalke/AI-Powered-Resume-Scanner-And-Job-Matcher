...
## Overview
An NLP-based web application developed using Python and Streamlit to compare resumes with job descriptions and calculate resume-job similarity scores.

## Features
- Upload resumes and job descriptions
- Calculate resume-job similarity scores using TF-IDF and Cosine Similarity
- Identify matching keywords between resumes and job descriptions
...
### Home Page
![home page](https://github.com/KomalPhalke/AI-Powered-Resume-Scanner-And-Job-Matcher/blob/main/home%20page.PNG?raw=true)
### Upload Resume
...
### Resume Structure
![resume structure](https://github.com/KomalPhalke/AI-Powered-Resume-Scanner-And-Job-Matcher/blob/main/show%20resume%20structure.PNG?raw=true)
